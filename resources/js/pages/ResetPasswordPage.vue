...
<template>
    <AuthLayout>
        <form class="space-y-5" @submit.prevent="submit">
            ...
            <FormInput id="password" v-model="form.password" label="New password" type="password" autocomplete="new-password" :error="errors.password" />
            <FormInput
            ...
            <AppButton type="submit" icon="pi-lock" :loading="loading">{{ loading ? 'Resetting...' : 'Reset password' }}</AppButton>
