...
class BookingController extends Controller
{
    ...
    public function show(Booking $booking): JsonResponse
    {
        return response()->json([
            ...
            'data' => ['booking' => new BookingResource($booking->load(['customer.role', 'worker.role', 'selectedWorker.role', 'service', 'cancelledBy.role', 'activities.actor.role', 'review.customer.role', 'workerReview.worker.role']))],
        ]);
    }
