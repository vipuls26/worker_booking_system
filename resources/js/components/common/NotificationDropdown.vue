                ...
                <div v-for="notification in recentNotifications" :key="notification.id"
                    ...
                    <button type="button" class="flex min-w-0 flex-1 items-start gap-3 text-left"
                        ...
                        <span class="min-w-0 flex-1">
                            <p data-testid="notification-item-title" class="truncate text-sm font-medium text-slate-900 dark:text-slate-100">{{
                                notification.title }}</p>
                            <p data-testid="notification-item-message" class="mt-1 line-clamp-2 text-xs text-slate-500 dark:text-slate-400">{{
