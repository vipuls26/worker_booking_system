            ...
            <AppPanel>
                <form class="space-y-5" @submit.prevent="submit">
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Keep your identity details accurate for audit and platform notifications.</p>
                    </div>

                    <div class="grid gap-4 sm:grid-cols-2">
                        <FormInput id="admin_name" v-model="form.name" label="Name" autocomplete="name" :error="errors.name" />
                        <FormInput id="admin_phone" v-model="form.phone" label="Phone" autocomplete="tel" :error="errors.phone" />
                    </div>

                    <FormInput id="admin_email" v-model="form.email" type="email" label="Email" autocomplete="email" :error="errors.email" />
