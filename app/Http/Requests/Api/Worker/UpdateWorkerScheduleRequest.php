...
class UpdateWorkerScheduleRequest extends ApiFormRequest
{
    ...
    public function after(): array
    {
        return [
            function (Validator $validator): void {
                ...
                $ignoreId = $this->route('workerSchedule')?->id;
                $conflict = $schedules->conflictsWithDayMode($this->user(), $this->validated(), $ignoreId);
                ...
                if ($schedules->overlaps($this->user(), $this->validated(), $ignoreId)) {
